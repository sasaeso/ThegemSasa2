package com.sasa.playerevolutions;
import com.sasa.playerevolutions.util.ModWorldGen;
...
public class PlayerEvolutions {private static final Logger LOGGER = LogManager.getLogger();
    ...
    public PlayerEvolutions() {
        ...
        net.minecraftforge.fml.event.lifecycle.FMLCommonSetupEvent.class.getClass();
        FMLJavaModLoadingContext.get().getModEventBus().addListener(this::setup);
    }
