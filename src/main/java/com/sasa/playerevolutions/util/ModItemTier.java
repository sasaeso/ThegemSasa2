...
public enum ModItemTier implements IItemTier {
    // Stats: HarvestLevel, MaxUses (Durability), Efficiency, AttackDamage, Enchantability, RepairMaterial
    SASA(4, 2000, 9.0F, 7.0F, 22, () -> {
        return Ingredient.fromItems(RegistryHandler.SASA.get());
    });
